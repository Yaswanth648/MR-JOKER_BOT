...
def mrjoker_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} Is the redisigned version of Mr.Joker for the best performance.*"
            f"\n\nBased on  [Mr.Joker](https://t.me/lkhitech)."
            f"\n\n{dispatcher.bot.first_name}'s source code was written by Kavindu AJ, Mr.Dani, Ashen Shaluka and Developers"
        ...
        query.message.edit_text(
            ...
            f"\n🔹 Some modules in this bot is owned by different authors, So, \n  All credits goes to only LKHITECH™️\n  Also for <b>Paul Larson for Marie</b>."
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        mrjoker_about_callback, pattern=r"aboutmanu_"
    )
